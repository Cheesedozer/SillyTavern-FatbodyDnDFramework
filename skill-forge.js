/**
 * skill-forge.js — Fatbody Framework (Modern RPG mode, v3.0)
 *
 ...
 *
 * Imports: state-manager.js, llm-client.js, progression-engine.js
        ...
        if (n.type === 'active') {
            ...
            if (hasResource) {
                if (!resourceIds.has(n.resourceCost.resourceId)) {
                    err(`${at}: resourceCost.resourceId "${n.resourceCost?.resourceId}" not a foundation resource`);
                }
...
{ "id": "lowercase_slug", "name": "...", "tier": ${tier}, "type": "active"|"passive",
  ...
  "resourceCost": {"resourceId": "...", "amount": N} (actives),
