/**
 * progression-engine.js — Fatbody Framework (Modern RPG mode, v3.0)
 *
 * Deterministic leveling math for the Modern (level 1–100) campaign mode.
 ...
 *    round(10 · (L−10)^1.8 · costMultiplier) — payable for a one-node fix at
 *    mid levels, a major currency investment by level 45+.
 *
 * Imports: none (leaf module).
 * Imported by: state-pass.js (threshold detection), index.js (UI),
 *              skilltree-protocol.js (validation).
 */
 ...
 * Format matches the existing renderer parsers (renderer.js / memo-processor).
 * @param {number} xp - cumulative XP
