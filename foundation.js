/**
 * foundation.js — Fatbody Framework (Modern RPG mode, v3.0)
 *
 ...
 *
 * Imports: state-manager.js, router.js (writeBookToDisk)
...
export function validateFoundation(f) {
    ...
    if (!pr || typeof pr !== 'object') err('PROGRESSION_RULES object is required');
        ...
        if (pr.maxLevel !== 100) err('PROGRESSION_RULES.maxLevel must be 100 (Modern mode contract)');
